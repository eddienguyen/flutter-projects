...
List<Planet> planets = [
  const Planet(
    ...
    backgroundImageUrl: "https://www.nasa.gov/sites/default/files/thumbnails/image/pia21723-16.jpg",
  ),
  const Planet(
    id: "2",
    name: "Neptune",
    ...
    distance: "54.6m Km",
    gravity: "11.15 m/s",
    description: "Neptune is the eighth and farthest known planet from the Sun in the Solar System. In the Solar System, it is the fourth-largest planet by diameter, the third-most-massive planet, and the densest giant planet. Neptune is 17 times the mass of Earth and is slightly more massive than its near-twin Uranus, which is 15 times the mass of Earth and slightly larger than Neptune.[d] Neptune orbits the Sun once every 164.8 years at an average distance of 30.1",
    imageUrl: "assets/images/neptune.png",
    backgroundImageUrl: "https://www.nasa.gov/sites/default/files/styles/full_width_feature/public/images/110411main_Voyager2_280_yshires.jpg",
  ),
  const Planet(
    id: "3",
    name: "Earth",
    ...
    backgroundImageUrl: "https://www.nasa.gov/sites/default/files/styles/full_width_feature/public/thumbnails/image/iss042e340851_1.jpg",
  ),
  const Planet(
    id: "4",
    name: "Moon",
    ...
    backgroundImageUrl: "https://farm5.staticflickr.com/4086/5052125139_43c31b7012.jpg",
  ),
  const Planet(
    id: "5",
    name: "Mercury",
    ...
    backgroundImageUrl: "https://c1.staticflickr.com/9/8105/8497927473_2845ae671e_b.jpg"
  ),
];
